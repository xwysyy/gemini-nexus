...
export const translations = {
    en: {
        ...
        "pageContextPromptLabel": "Page",
        "pageContextPromptPlaceholder": "Optional default prompt when enabling page chat.",
        "ocrPromptLabel": "OCR",
        "ocrPromptPlaceholder": "Optional override for OCR prompt.",
        "screenshotTranslatePromptLabel": "Screenshot Translate",
        "screenshotTranslatePromptPlaceholder": "Optional override for screenshot translation prompt.",
        "snipPromptLabel": "Snip",
        "snipPromptPlaceholder": "Optional default prompt for screenshot analysis.",
    ...
    zh: {
        ...
        "commonPrompts": "常用提示词",
        "pageContextPromptLabel": "网页",
        "pageContextPromptPlaceholder": "可选：开启网页对话时自动填入的默认提示词。",
        "ocrPromptLabel": "OCR",
        "ocrPromptPlaceholder": "可选：覆盖 OCR 默认提示词。",
        "screenshotTranslatePromptLabel": "截图翻译",
        "screenshotTranslatePromptPlaceholder": "可选：覆盖截图翻译默认提示词。",
        "snipPromptLabel": "截图",
        "snipPromptPlaceholder": "可选：截图分析时自动填入的默认提示词。",
