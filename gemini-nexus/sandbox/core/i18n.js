...
export const translations = {
    en: {
        ...
        "pageContextImagesToggleDesc": "When page chat is enabled, attach up to 5 compressed images from the current page as temporary context.",
    ...
    zh: {
        ...
        "pageContextImagesToggleDesc": "启用网页对话时，最多附带 5 张当前页面中的压缩图片作为临时上下文。",
